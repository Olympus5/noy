				...
				case SC_EXEC: {
					...
					case SC_JOIN: {
						...
						case SC_P: {
							...
							Semaphore* ptSem;
							tid = g_machine->ReadIntRegister(4);
							ptSem = (Semaphore*)g_object_ids->SearchObject(tid);

							if(ptSem && ptSem->type == SEMAPHORE_TYPE) {
								ptSem->P();
								g_syscall_error->SetMsg((char*)"", NO_ERROR);
								g_machine->WriteIntRegister(2,0);
							} else {
						...
						case SC_SEM_CREATE: {
							...
							DEBUG('e', (char*)"Process or thread: SemCreate call.\n");
							...
							ptSem = new Semaphore(sem_name, count);
							int32_t tid;
							tid = g_object_ids->AddObject(ptSem);
						...
						case SC_SEM_DESTROY: {
							DEBUG('e', (char*)"Process or thread: SemDestroy call.\n");
						...
						case SC_LOCK_CREATE: {
							DEBUG('e', (char*)"Process or thread: LockCreate.\n");
							...
							int size = GetLengthParam(name_addr);
							char lck_name[size];
							GetStringParam(name_addr, lck_name, size);

							ptLock = new Lock(lck_name);
							int32_t tid;
							tid = g_object_ids->AddObject(ptLock);
						...
						case SC_LOCK_DESTROY: {
							DEBUG('e', (char*)"Process or thread: LockDestroy call.\n");

							int32_t tid;
							Lock* ptLock;
							tid = g_machine->ReadIntRegister(4);
							ptLock = (Lock *)g_object_ids->SearchObject(tid);
						...
						case SC_LOCK_ACQUIRE: {
							DEBUG('e', (char*)"Process or thread: Acquire call");
							int32_t tid;
							Lock* ptLock;
						...
						case SC_LOCK_RELEASE: {
							DEBUG('e', (char*)"Process or thread: Release call");
							int32_t tid;
							Lock* ptLock;
							tid = g_machine->ReadIntRegister(4);
							ptLock = (Lock*)g_object_ids->SearchObject(tid);
						...
						case SC_COND_CREATE: {
							DEBUG('e', (char*)"Process or thread: CondCreate.\n");
							...
							int32_t tid;
							tid = g_object_ids->AddObject(ptCond);
						...
						case SC_COND_DESTROY: {
							DEBUG('e', (char*)"Process or thread: CondDestroy call.\n");

							int32_t tid;
							Condition* ptCond;
							tid = g_machine->ReadIntRegister(4);
							ptCond = (Condition *)g_object_ids->SearchObject(tid);
						...
						case SC_COND_SIGNAL: {
							DEBUG('e', (char*)"Process or thread: Signal call");
							int32_t tid;
							Condition* ptCond;
						...
						case SC_COND_WAIT: {
							DEBUG('e', (char*)"Process or thread: Wait call");
						...
						case SC_COND_BROADCAST: {
							DEBUG('e', (char*)"Process or thread: Broadcast call");
